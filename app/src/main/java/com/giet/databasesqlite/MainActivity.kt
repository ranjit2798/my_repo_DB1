package com.giet.databasesqlite
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        u_id=findViewById<EditText>(R.id.u_id)
        u_email=findViewById<EditText>(R.id.u_email)
        u_name=findViewById<EditText>(R.id.u_name)
    }
    ...
    fun updateRecord(view: View){
        ...
        val edtId = dialogView.findViewById(R.id.textViewId) as TextView
        val edtName = dialogView.findViewById(R.id.textViewName) as TextView
        val edtEmail = dialogView.findViewById(R.id.updateEmail) as TextView
